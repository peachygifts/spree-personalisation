...
desc 'Generate documentation for the personalisation extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PersonalisationExtension'
...
desc 'Test the personalisation extension.'
...
namespace :test do
  desc 'Functional test the personalisation extension.'
  ...
  desc 'Unit test the personalisation extension.'
